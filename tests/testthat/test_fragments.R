...
count_vec <- c(
  3, 3, 4, 3, 5, 5, 3, 3, 3, 2, 1, 3, 4, 1, 1, 2, 2, 2, 3, 5,
...
nucleosome_free <- c(
  3, 2, 4, 2, 1, 5, 2, 2, 2, 2, 1, 3, 2, 1, 1, 1, 2, 1, 1, 4,
...
read_vec <- c(
  5, 4, 6, 4, 10, 8, 4, 7, 12, 2, 5, 5, 5, 5, 2, 6, 2, 5, 6,
...
frags_header <- CreateFragmentObject(
  path = fpath_headered,
  cells = cells,
  verbose = FALSE,
  tolerance = 0.5
  ...
  expect_equal(
    ...
    expected = structure(
      list(
        ...
        barcode = c(
          "AAACTGCTCTTCCACG-1", "AAAGATGCACGCTGTG-1",
...
test_that("ExtractFragments works", {
  ...
  counts_headered <- ExtractFragments(
    fragments = frags_headered, verbose = FALSE
  )
...
test_that("FilterCells works", {
  ...
  expected <- structure(
    list(
      ...
      V2 = c(778433L, 778618L, 778663L, 778719L, 778737L, 778741L, 778808L,
             778853L, 778869L, 813095L, 821919L, 827477L, 827489L, 827501L),
      V3 = c(778658L, 778663L, 778796L, 778810L, 778781L, 778808L, 778844L,
             778932L, 778937L, 813174L, 822085L, 827596L, 827614L, 827560L),
      V4 = c("AAACGAACAAGCACTT-1", "AAACGAACAAGCGGTA-1", "AAACGAACAAGCGGTA-1",
             "AAACGAAAGGAAGAAC-1", "AAACGAAAGTCGACCC-1", "AAACGAACAAGCGGTA-1",
             "AAACGAACAAGCACTT-1", "AAACGAAAGGAAGAAC-1", "AAACGAACAAGCGGTA-1",
             "AAACGAACAAGCGGTA-1", "AAACGAAAGTCGACCC-1", "AAACGAAAGTCGACCC-1",
             "AAACGAACAAGCACTT-1", "AAACGAAAGAGAGGTA-1"),
...
test_that("SplitFragments works", {
  ...
  expect_equal(
    ...
    expected = structure(list(V1 = c(
      ...
      267990L, 586175L, 633984L, 633994L, 634004L,
      ...
      827511L, 827543L, 827556L, 827560L, 827566L, 827571L
    ), V3 = c(
      268023L,
      ...
      827602L, 827602L, 827801L
    ), V4 = c(
      "AAACTCGAGAGGCCTA-1", "AAAGGATCAATACTGC-1",
      ...
      1L, 2L, 5L, 1L, 5L, 2L, 3L, 1L, 4L, 3L, 2L, 3L, 1L,
  ...
  expect_equal(
    ...
    expected = structure(list(V1 = c(
      ...
      827579L, 827581L, 827591L, 827719L
    ), V3 = c(
      10216L, 77221L, 181131L,
      ...
      827648L, 827650L, 827635L, 827768L
    ), V4 = c(
      "AAACTGCTCTTCCACG-1",
      ...
      "AAACTGCCATCGCCTT-1", "AAACGAACACATATCG-1"
    ), V5 = c(
      2L, 1L, 1L,
