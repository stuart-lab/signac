...
For more information about installing Seurat, see the Seurat [website](https://satijalab.org/seurat/install.html)

### Bioconductor packages {.tabset}
...
It can be also useful to also install species-speciic packages from bioconductor:
