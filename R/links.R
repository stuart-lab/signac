...
#' peak given the GC content, accessibility, and length of the peak. The
#' expected coefficient values for the peak are then used to compute a z-score
#' and p-value.
#'
