...
splitFragments <- function(fragments, cells, idents, unique_idents, buffer_length, verbose = TRUE) {
    .Call('_Signac_splitFragments', PACKAGE = 'Signac', fragments, cells, idents, unique_idents, buffer_length, verbose)
}
