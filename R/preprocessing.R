#' @param motifs A motif x region matrix. Regions in the motif matrix (colnames)
#' must match the regions in the assay region x cell matrix (rownames ).
#' @param verbose Display messages
#'
#' @rdname AddMotifMatrix
#' @export
AddMotifMatrix.default <- function(
  object,
  motifs,
  assay = NULL,
  verbose = TRUE
  ...
  # TODO
  # check for compatible dimensions and store in the misc slot of the assay
  # make dgCMatrix of given in other format
  return(object)
}

#' @rdname AddMotifMatrix
#' @method AddMotifMatrix Assay
#' @export
AddMotifMatrix.Assay <- function(
  object,
  motifs,
  assay = NULL,
  verbose = TRUE
...
#' @rdname AddMotifMatrix
#' @method AddMotifMatrix Seurat
#' @export
AddMotifMatrix.Seurat <- function(
  object,
  motifs,
  assay = NULL,
  verbose = TRUE
