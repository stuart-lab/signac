...
#' @param scale.factor Scaling factor for track height. Default is 10^6.
...
CalculateCoverages <- function(
  ...
  expanded$norm.value <- expanded$value / lut[expanded$group] / cells.per.group[expanded$group] * scale.factor
