...
// splitFragments
int splitFragments(std::string fragments, std::vector<std::string> cells, std::vector<std::string> idents, std::vector<std::string> unique_idents, int buffer_length, bool verbose);
RcppExport SEXP _Signac_splitFragments(SEXP fragmentsSEXP, SEXP cellsSEXP, SEXP identsSEXP, SEXP unique_identsSEXP, SEXP buffer_lengthSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type fragments(fragmentsSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type buffer_length(buffer_lengthSEXP);
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    rcpp_result_gen = Rcpp::wrap(splitFragments(fragments, cells, idents, unique_idents, buffer_length, verbose));
    return rcpp_result_gen;
END_RCPP
}
// validateCells
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_Signac_splitFragments", (DL_FUNC) &_Signac_splitFragments, 6},
