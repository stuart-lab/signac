...
For a full changelog please see the package [release notes](https://stuartlab.org/signac/news/).
...
```{r}
frag.path <- system.file("extdata", "fragments_header.tsv.gz", package="Signac")
