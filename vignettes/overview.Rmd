...
## [Large-scale scATAC-seq analysis with REMO and BPCells](fetal_remo.html)

In this tutorial we demonstrate how to analyze a large scATAC-seq dataset of >500,000
cells using REMO and BPCells.

```{r echo=FALSE, out.height="30%"}
knitr::include_graphics("./assets/fetal.png")
```
