...
To demonstrate we'll use a dataset provided by 10x Genomics for human PBMCs.
...
peak size. See the [Signac paper]() for a full description of the method we 
use to link peaks to genes.
