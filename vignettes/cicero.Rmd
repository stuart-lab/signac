...
This is the same dataset we used in the [Monocle 3](https://satijalab.org/signac/articles/monocle.html)
vignette, and we'll start by loading the dataset that was created in that
vignette. See the [Monocle 3](https://satijalab.org/signac/articles/monocle.html)
