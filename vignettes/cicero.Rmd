...
This is the same dataset we used in the [trajectory](https://satijalab.org/signac/articles/monocle.html)
vignette, and we'll start by loading the dataset that was created in that
vignette. See the [trajectory](https://satijalab.org/signac/articles/monocle.html)
vignette for the code used to create the object from raw data.
