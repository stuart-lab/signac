...
VlnPlot(crc, c("TSS_enrichment", "nCount_peaks", "Nucleosome_signal", "pct_reads_in_peaks", "pct_reads_in_DNase", "blacklist_ratio"), pt.size = 0, ncol = 3)
```
...
# create an assay
mito <- CreateAssay5Object(counts = mito.data$counts)
