...
- GATA3 and KIT is a TReg markers in this dataset. 
...
cell type yields slightly reduced mtDNA coverage compared to 
...
occurson one but not the other strand. This is due to the preceding nucleotide 
...
accessibility differences utilizing the multi-modal capabilities of Signac. 
...
# load the peak set
peaks <- read.table(
  file = "~/data/mito/tf1/TF1.filtered.narrowPeak.gz",
  sep = "\t",
...
frags <- CreateFragmentObject(
  path = "~/data/mito/tf1/TF1.filtered.fragments.tsv.gz",
  cells = colnames(tf1)
)
