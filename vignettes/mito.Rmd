...
Here, we analyze a dataset containing both DNA accessibility measurements and
mitochondrial mutation data in the same cells, sampled from a patient with 
a colorectal cancer (CRC) tumor. This data was produced by Lareau and Ludwig et
al. (2020), and you can read the original paper here: XXX
...
```{r viz_gene_activitites, message=FALSE, warning = FALSE}
