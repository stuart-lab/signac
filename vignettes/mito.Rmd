...
these mutations arise in the genome.
...
head(markers.fast)
```
We can the DNA accessibility in these regions for each clone using the `CoveragePlot()`
function. As you can see, the peaks identified are highly specific to one clone.
