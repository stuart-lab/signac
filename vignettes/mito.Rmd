...
We have re-processed the original data mapping to the hg38 genome. These updated
files, including mitochondrial variant data for the CRC and TF1
datasets, are available on Zenodo here: https://zenodo.org/records/19450459

Original sequencing reads and processed data mapped to hg19 for the these datasets
...
We can see that most of the low FRIP cells were the myeloid cluster. This is
...
cell type yields slightly reduced mtDNA coverage compared to the other myeloid
cluster.
