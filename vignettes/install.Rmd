...
We provide docker images for Signac via [github packages](https://github.com/timoast/signac/packages).

```{bash}
docker pull docker.pkg.github.com/timoast/signac/signac:latest
```
