...
```{r}
VlnPlot(pbmc, c("TSS_enrichment", "Nucleosome_signal", "total_fragments"), group.by = "orig.ident", ncol = 3, pt.size = 0)
```
...
```{r message=FALSE, warning=FALSE}
enrichments <- EnrichedTerms(pbmc, terms = celltypes, group.by = "seurat_clusters")
```
